...
public class COSTouchInputControler:ScriptableObject
{
    static int walkableAreaMask;

    public COSTouchInputControler()
    {
...
//                selected = null;
    ...
    /// 
    public RaycastHit TouchUpdate(Camera _camera)
    {
...
//                                return hit;
//                                if (ClashBattleCamera. && !EventSystem.current.IsPointerOverGameObject(touches[0].fingerId))
//                                {
//                                    
//                                }
